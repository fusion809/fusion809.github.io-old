## openSUSE
{% include OS-post/os-shot.html image="openSUSE-42.1-desktop-screenshot-appmenu.png" float="none" description="Screenshot of openSUSE 42.1 with its default wallpaper." width="1140px" %}
...
{% include OS-post/os-shot.html image="openSUSE-42.1-YaST2-running.png" width="1140px" float="none" description="YaST2 running on openSUSE 42.1" %}
