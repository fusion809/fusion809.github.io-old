## Mageia
{% include OS-post/os-shot.html image="Mageia-5-KDE4.png" float="none" description="Mageia 5 with its default KDE Plasma 4 desktop." width="1140px" %}
...
### Package Management
{% include OS-post/os-shot.html image="Mageia-5-rpmdrake-6.20.png" width="1140px" float="none" description="rpmdrake 6.20 running on Mageia 5" %}
