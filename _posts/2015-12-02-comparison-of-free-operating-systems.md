...
{% include os-ratings.html bf="9." cmb="<6." doc="4. Fairly minimal documentation of its own" sup="? Never had to use their forums." pm="7." sru="4." sb="&geq;7. Never experienced any bugs myself, but I know from experience on other platforms that Cinnamon can be buggy."  mewi="&leq;4." oa="7-8." %}
