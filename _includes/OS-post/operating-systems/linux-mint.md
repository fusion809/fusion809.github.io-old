## Linux Mint
{% include OS-post/os-shot.html image="Linux-Mint-17.3.png" width="1150px" description="Linux Mint 17.3 with the default Cinnamon desktop" float="none" %}
